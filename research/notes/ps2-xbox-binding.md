...
## Part 1: call-graph crawl — 228 PS2 methods across 131 classes, address-verified
...
**Result**: 228 confirmed `(real PS2 address → Class::method)` pairs across 131 distinct classes.
