...
## Part 1: call-graph crawl — 525 PS2 methods across 238 classes, address-verified
...
The thirty-fifth pass crawled ten CGtLobbyPS2DirtySock callback, ranking, chat, and player-parameter methods and reached JoinLobbyCallback plus the input-device update. Twelve fresh entries were retained after deduplication.
