...
## Part 1: call-graph crawl — 633 PS2 methods across 240 classes, address-verified
...
The fiftieth pass crawled seven CGtNATDataManager registration, callback, entry, and port-mapping methods and reached the already-known SetUpAPortMapping helper. Seven fresh entries were retained after deduplication.
