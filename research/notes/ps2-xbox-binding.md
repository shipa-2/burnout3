...
## Part 1: call-graph crawl — 217 PS2 methods across 123 classes, address-verified
...
**Result**: 217 confirmed `(real PS2 address → Class::method)` pairs across 123 distinct classes.
