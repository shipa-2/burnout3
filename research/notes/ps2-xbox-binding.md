...
## Part 1: call-graph crawl — 297 PS2 methods across 189 classes, address-verified
...
**Result**: 297 confirmed `(real PS2 address → Class::method)` pairs across 189 distinct classes.
