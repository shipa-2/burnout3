...
## Part 1: call-graph crawl — 245 PS2 methods across 141 classes, address-verified
...
**Result**: 245 confirmed `(real PS2 address → Class::method)` pairs across 141 distinct classes.
